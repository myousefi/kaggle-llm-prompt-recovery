...
alpaca_prompt = """You are a prompt engineer. Compare the original text versus the rewritten text. Analyze the style of the two texts. You should respond with the rewriting prompt, the prompt that was used to rewrite the original into the rewritten text.
